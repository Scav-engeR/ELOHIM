...
class OSINTDatabase:
    """Comprehensive OSINT platform database with extended coverage"""
    ...
    GAMING_PLATFORMS = {
        ...
        'Battle.net': 'https://worldofwarcraft.com/en-us/character/us/{}/{}',
        'Epic Games': 'https://fortnitetracker.com/profile/pc/{}',
        'Origin': 'https://origin.com/en-us/profile/user/{}',
        ...
        'World of Tanks': 'https://worldoftanks.com/en/community/accounts/{}',
        'CS:GO': 'https://csgostats.gg/player/{}',
    ...
    DATING_PLATFORMS = {
        ...
        'eHarmony': 'https://eharmony.com/{}',
        'Plenty of Fish': 'https://pof.com/viewprofile.aspx?profile_id={}',
    ...
    FINANCIAL_PLATFORMS = {
        ...
        'Buy Me Coffee': 'https://buymeacoffee.com/{}',
        'Kickstarter': 'https://kickstarter.com/profile/{}',
        'GoFundMe': 'https://gofundme.com/f/{}',
    ...
    MUSIC_PLATFORMS = {
        ...
        'Tidal': 'https://tidal.com/browse/user/{}',
...
class ElohimCore:
    ...
    async def run_username_search(self, username: str, platform_types: List[str], include_nsfw: bool = False) -> Dict[str, Any]:
        """Execute enhanced username search with extended coverage"""
        platforms = {}
        
        if 'social' in platform_types:
            platforms.update(OSINTDatabase.SOCIAL_PLATFORMS)
        if 'gaming' in platform_types:
            platforms.update(OSINTDatabase.GAMING_PLATFORMS)
        if 'dev' in platform_types:
            platforms.update(OSINTDatabase.DEV_PLATFORMS)
        if 'business' in platform_types:
            platforms.update(OSINTDatabase.BUSINESS_PLATFORMS)
        if 'dating' in platform_types:
            platforms.update(OSINTDatabase.DATING_PLATFORMS)
        if 'forum' in platform_types:
            platforms.update(OSINTDatabase.FORUM_PLATFORMS)
        if 'financial' in platform_types:
            platforms.update(OSINTDatabase.FINANCIAL_PLATFORMS)
        if 'music' in platform_types:
            platforms.update(OSINTDatabase.MUSIC_PLATFORMS)
        
        # Extended coverage including NSFW platforms
        if include_nsfw:
            ElohimLogger.warning("Including NSFW platforms in scan")
            platforms.update(OSINTDatabase.NSFW_PLATFORMS)
